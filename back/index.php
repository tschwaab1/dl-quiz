    ...
    <section class="d-flex flex-column justify-content-between" id="hero">
        <div id="top-div">
            <nav class="navbar navbar-light navbar-expand-md">
                <div class="container-fluid"><a class="navbar-brand" href="#">Logo&nbsp;</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="font-family: Montserrat, sans-serif;"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
            ...
            <div class="container" style="margin-bottom: 45px;">
                <div class="row">
                    <div class="col-sm-10 col-md-10 col-lg-8 col-xl-6 offset-sm-1 offset-md-1 offset-lg-2 offset-xl-3 text-center align-self-center">
                        <p style="font-family: Montserrat, sans-serif;">Free paragraph</p><a class="nounderline" href="./quiz.php"><button class="btn btn-primary btn-block text-center flex-grow-0 flex-shrink-0 start-button" type="button" style="background-color: rgba(204,122,0,0.51);">Take mock theory test</button></a></div>
                </div>
            </div>
            <div>
                <footer id="copyrightfooter">
                    <p>© WIE 01&nbsp;2020&nbsp;-&nbsp;All&nbsp;right&nbsp;reserved<br></p>
                </footer>
            </div>
        </div>
    </section>
